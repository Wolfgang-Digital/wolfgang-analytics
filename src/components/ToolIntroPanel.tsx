...
import { Grid, Image, Heading, Text, PseudoBox, Button, Link as ExternalLink, Flex } from '@chakra-ui/core';
          ...
          <Flex marginTop={4}>
            {learnMoreLink && (
              <ExternalLink href={learnMoreLink} isExternal>
                <Button variant="outline" color="white" _hover={{ color: 'white' }} rightIcon="external-link" size="sm" marginRight={2}>
                  Learn More
                </Button>
              </ExternalLink>
            )}
            <Link to={link}>
              <Button variant="outline" color="white" _hover={{ color: 'white' }} rightIcon="link" size="sm">
                Go to Tool
              </Button>
            </Link>
          </Flex>
